...
var CurrencyInput = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(CurrencyInput, [{
    ...
    value: function componentWillReceiveProps(newProps) {
      var isOptionsChanged = JSON.stringify(_objectSpread(_objectSpread({}, this.props), {}, {
        value: undefined
      })) !== JSON.stringify(_objectSpread(_objectSpread({}, newProps), {}, {
        value: undefined
      }));
      ...
      if (isOptionsChanged) {
        this.autonumeric.update(_objectSpread(_objectSpread(_objectSpread({}, newProps.preDefined), newProps), {}, {
          onChange: undefined,
          onFocus: undefined,
          onBlur: undefined,
          onKeyPress: undefined,
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          InputProps = _this$props2.InputProps,
          others = _objectWithoutProperties(_this$props2, ["classes", "currencySymbol", "variant", "inputProps", "InputProps"]);

      var otherProps = {};
      ["id", "value", "label", "className", "autoFocus", "style", "error", "disabled", "disableUnderline", "type", "name", "defaultValue", "tabIndex", "fullWidth", "rows", "rowsMax", "select", "required", "helperText", "unselectable", "margin", "SelectProps", "multiline", "readOnly", "size", "FormHelperTextProps", "placeholder", "startAdornment", "endAdornment"].forEach(function (prop) {
      ...
      if (variant === "outline") {
        ...
        return /*#__PURE__*/_react["default"].createElement(_FilledInput["default"], _extends({
          inputRef: function inputRef(ref) {
            return _this2.input = ref;
          },
          onChange: function onChange(e) {
...
CurrencyInput.propTypes = {
  ...
  startAdornment: _propTypes["default"].ReactNode,
  endAdornment: _propTypes["default"].ReactNode
};
...
var _default = (0, _styles.withStyles)(styles)(CurrencyInput);
